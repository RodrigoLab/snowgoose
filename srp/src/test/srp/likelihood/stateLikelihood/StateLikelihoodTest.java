...
//	private SpectrumAlignmentModel spectrumModel;
	...
	@Test
		public void testCalculateStatesLogLikelihood2D() throws Exception {
			...
			for (int i = 0; i < spectraFrequencies.length; i++) {
				...
				stateLikelihood.calculateStatesLogLikelihood2D(sp, statesLogLikelihood);
				...
				stateLikelihood.calculateStoredStatesLogLikelihood2D(sp, statesLogLikelihood);
				assertArrayEquals(expectedLogLikelihood, statesLogLikelihood, THRESHOLD);
