...
//import srp.spectrum.CategorySpectrum;
...
//
//
//public class ShortReadsCategoriesSpectrumLikelihood  extends AbstractModelLikelihood {
//
...
//
//	public ShortReadsCategoriesSpectrumLikelihood(CategorySpectrumAlignmentModel spectrumModel, ShortReadMapping srpMap){
...
//				CategorySpectrum spectrum = spectrumModel.getSpectrum(j);
...
//				CategorySpectraParameter spectra = spectrum.getSpectra(k);
...
//			break;
//		default:
//			throw new IllegalArgumentException("Unknown operation type: "+operation +"\tin"+ShortReadsCategoriesSpectrumLikelihood.class.getSimpleName() );
////			storeEverything();
////			break;
//			
//		}
