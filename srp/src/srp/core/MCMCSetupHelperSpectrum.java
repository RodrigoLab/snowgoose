...
import srp.operator.spectrum.DeltaMixMultiSpectrumOperator;
...
import srp.operator.spectrum.SwapColumnSpectrumOperator;
import srp.operator.spectrum.SwapMultiSpectrumOperator;
import srp.operator.spectrum.SwapSingleSpectrumOperator;
import srp.operator.spectrum.SwapSubColumnSpectrumOperator;
import srp.operator.spectrum.testCategoriesChangeSpectrumOperator;
import srp.operator.spectrum.testCategoriesSwapSpectrumOperator;
...
//			schedule.addOperator(operator);
			...
			operator = new DeltaMixMultiSpectrumOperator(spectrumModel, 1,
