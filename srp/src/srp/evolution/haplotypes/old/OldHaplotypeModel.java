...
public class OldHaplotypeModel extends OldAbstractHaplotypeModel  {
...
//	int haplotypesCount;
	...
	private OldHaplotypeModel(AlignmentMapping aMap){
		super(MODEL_NAME);
...
//		storedCumSumFrequency[INDEX_OF_LAST_VALID_CHARS]=1;
	...
	private OldHaplotypeModel(Alignment shortReads) {
...
//			char newChar = (char) aMap.nextBaseAt(i);
	...
	public OldHaplotypeModel(AlignmentMapping aMap, int hapCount) {
		this(aMap);		
		initSeqs(hapCount);
		
	}

	public OldHaplotypeModel(AlignmentMapping aMap, Alignment trueAlignment) {
		this(aMap);
	...
	public OldHaplotypeModel(Alignment shortReads, int hapCount) {
