...
public abstract class OldAbstractHaplotypeModel extends AbstractModel implements Alignment {

	
	public OldAbstractHaplotypeModel(String name) {
		super(name);
	}
	...
	protected ArrayList<OldHaplotype> haplotypes;
	...
	public OldHaplotype getHaplotype(int i){
...
//    }
	...
	public int[] getSitePattern(int siteIndex) {
        ...
        for (int i = 0; i < n; i++) {
            OldHaplotype hap = getHaplotype(i);
	...
	public int getState(int taxonIndex, int siteIndex) {
        OldHaplotype hap = getHaplotype(taxonIndex);
