...
public class OldHaplotype extends Sequence {
	...
	public OldHaplotype(String sequence) {
		this();
		setSequenceString(sequence.toUpperCase());
	}

	public OldHaplotype(Sequence sequence) {
		this(sequence.getTaxon(), sequence.getSequenceString());
	}

	public OldHaplotype(Taxon taxon, String sequence) {
		this();
		setTaxon(taxon);
