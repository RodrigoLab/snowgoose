...
public class HaplotypeExtSeq extends Sequence {
	...
	public HaplotypeExtSeq() {
		sequenceString = new StringBuilder();
	}

	public HaplotypeExtSeq(String sequence) {
		this();
		setSequenceString(sequence.toUpperCase());
	}

	public HaplotypeExtSeq(Sequence sequence) {
		this(sequence.getTaxon(), sequence.getSequenceString());
	}

	public HaplotypeExtSeq(Taxon taxon, String sequence) {
		this();
		setTaxon(taxon);
