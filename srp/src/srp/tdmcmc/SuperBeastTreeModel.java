...
public class SuperBeastTreeModel extends AbstractModel implements MutableTree {

	//
	// Aim for 95+% identical to original to BEAST TreeModel
	//
    ...
    public SuperBeastTreeModel(String name) {
        super(name);
        nodeCount = 0;
        externalNodeCount = 0;
        internalNodeCount = 0;
    ...
    public SuperBeastTreeModel(Tree tree) {
        this(TREE_MODEL, tree, false);
    }

    public SuperBeastTreeModel(String id, Tree tree) {
    ...
    public SuperBeastTreeModel(String name, Tree tree, boolean copyAttributes) {
